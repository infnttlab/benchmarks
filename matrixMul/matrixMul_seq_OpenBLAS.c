...
//	sgemm_(&transA, &transB, &sizeMatrix, &sizeMatrix, &sizeMatrix, &one, h_A, &sizeMatrix, h_B, &sizeMatrix, &zero, h_C, &sizeMatrix);
	...
	cblas_sgemm(/*CblasColMajor*/CblasRowMajor, CblasNoTrans, CblasNoTrans, sizeMatrix, sizeMatrix, sizeMatrix, 1.f, h_A, 
               sizeMatrix, h_B, sizeMatrix, 0.f, h_C, sizeMatrix);
...
//	int ii, jj;
    ...
    //sgemm_(&transA, &transB, &sizeMatrix, &sizeMatrix, &sizeMatrix, &one, h_A, &sizeMatrix, h_B, &sizeMatrix, &zero, h_C, &sizeMatrix);
     ...
     //cblas_sgemm(order,transA,transB, sizeMatrix, sizeMatrix, sizeMatrix, 1.f, h_A,sizeMatrix, h_B, sizeMatrix, 0.f, h_C, sizeMatrix);
     cblas_sgemm(/*CblasColMajor*/CblasRowMajor, CblasNoTrans, CblasNoTrans, sizeMatrix, sizeMatrix, sizeMatrix, 1.f, h_A,
               sizeMatrix, h_B, sizeMatrix, 0.f, h_C, sizeMatrix);
