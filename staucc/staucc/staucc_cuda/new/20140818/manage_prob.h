...
void dpp_step2(gsl_rng *, int, int, LD*, LD*, struct globale*);
void dpp_step3(gsl_rng *, int, struct globale*);
LD   dpp_step4(int, LD, LD, int, struct globale*);

void dpp_update_tgt_vector(gsl_rng *, int, struct globale*);
void dpp_update_tgt_matrix(gsl_rng *, int, struct globale*);
