...
#define threadsPerBlock         27 // 256 numero di thread per blocco (che si sparticono le membrane di una simulazione)
#define numMems			27 // 1000 ogni thread computa (numMems/threadsPerBlock) membrane, che quindi deve essere intero
