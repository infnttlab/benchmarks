...
int main(int argc, char* argv[]) {
	...
	r = Reconstruction_FAN_BEAM_detector_interpolation_NOPreview(start,end,numBlocks,threadsPerBlock,dimBlock);
...
//-----------------------------------------------------------------------------
int	Reconstruction_FAN_BEAM_detector_interpolation_NOPreview(int start,int end,int numBlocks,int threadsPerBlock,int dimBlock) {

	//int		i=0;
	int		width,new_width,new_height;
	float	wmezzif;
	float	pxsize,rxsize,sod,sdd,odd;
	float	r=0.,fanangle=0.;
	//float 	l=0.;
...
//******************************************************************************
	...
	BackProjectFilteredDataOnSlice(FFT_lenght,FFT_start,xs,ys,xd0,yd0,xd1,yd1,numBlocks,threadsPerBlock,dimBlock);
