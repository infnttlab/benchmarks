...
//-----------------------------------------------------------------------------
extern int BackProjectFilteredDataOnSlice(int FFT_lenght,int FFT_start,float xs,float ys,float xd0,float yd0,float xd1,float yd1);
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
extern void ConstrainXstartXendIntoCircle_r(float r,float l, float rxsize,int width,int y_start, int y_end);
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
extern void	FFT(double *row_re,double *row_im,int FFT_lenght);
//-----------------------------------------------------------------------------
// inverse fft: inverse fast fourier transform
//-----------------------------------------------------------------------------
extern void	InvFFT(double *row_re,double *row_im,int FFT_lenght);
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
extern int	Reconstruction_FAN_BEAM_detector_interpolation_NOPreview(int start,int end);
